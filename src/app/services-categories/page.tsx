// @actions
import { deleteServicesCategories, getServicesCategories } from "./actions";
// @components
...
import { CreateServiceCategory } from "@/components/services-categories/create";
// @context
          ...
          <DataTableProvider
            ...
            <div className="w-full flex flex-col items-center justify-between gap-2 md:gap-0 md:flex-row">
              ...
              <div className="w-full flex gap-2 mb-4 md:w-auto md:mb-0">
                <Delete callback={deleteServicesCategories} />
